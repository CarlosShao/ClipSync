...
| 工单 | 状态 | 备注 |
|------|------|------|
| T-W0 脚手架+全页还原 | ✅ 完成（09-05） | build/check 全绿；DOM 与基线零差异；目检一致 |
| T-W1 SEO 收尾 | ✅ 完成（09-06） | og-cover 实图 36.8KB / 404 页 / 下载占位接线 / 修复 noscript 全页不可见 bug |
| T-W2 性能打磨 | 待派发 | Lighthouse CI 阈值接入；上线前做 |
