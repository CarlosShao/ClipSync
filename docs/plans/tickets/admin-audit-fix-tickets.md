...
### AF-01 系统参数 5 张卡保存链路失效 ✅（2026-09-08 b840631 落地） P0
...
### AF-02 运维监控「请求数 / 错误数 / p95」恒显示不可用 ✅（2026-09-08 b840631 落地） P0
...
### AF-03 RB-06 收尾：7 处读端点未挂 requirePerm ✅（2026-09-08 b840631 落地） P0
...
### AF-04 enable_signup 注册总开关服务端无守卫 ✅（2026-09-08 b840631 落地） P0
...
### AF-10 用户抽屉「赠期 1 个月」接线 ✅（2026-09-08 b840631 落地） P1
...
### AF-11 用户抽屉「强制下线」接线 ✅（2026-09-08 b840631 落地） P1
...
### AF-12 用户抽屉「删除账户」接线 ✅（2026-09-08 b840631 落地） P1
...
### AF-14 订单「导出」实现 ✅（2026-09-08 b840631 落地） P1
...
### AF-20 数据看板「待处理事项」恒空 ✅（2026-09-08 b840631 落地） P1
...
### AF-21 运维监控趋势图恒「等待下一次轮询采样…」 ✅（2026-09-08 b840631 落地） P2
...
### AF-22 公告「送达 / 已读 / 点击」口径修复 ✅（2026-09-08 b840631 落地） P1
...
### AF-23 备份概览恒空 ✅（2026-09-08 b840631 落地） P2
...
### AF-30 Grafana 跳转指向后端 API 端口 ✅（2026-09-08 b840631 落地） P1
...
### AF-31 顶栏「搜索：用户 / 订单 / IP」是纯装饰 ✅（2026-09-08 b840631 落地） P2 ⛔ 需产品决策
...
### AF-32 顶栏通知铃铛点击无反应 ✅（2026-09-08 b840631 落地） P2
...
### AF-33 审计日志「终端用户」筛选漏数据 ✅（2026-09-08 b840631 落地） P2
...
### AF-34 用户抽屉「查看审计日志」不带用户过滤 ✅（2026-09-08 b840631 落地） P2
...
### AF-40 退款：文案承诺与实现不符 ✅（2026-09-08 b840631 落地） P1 ⛔ 需产品决策
...
### AF-41 远程下线：文案承诺与实现不符 ✅（2026-09-08 b840631 落地） P2
...
### AF-42 menu_overrides 有写无读 ✅（2026-09-08 b840631 落地） P2 ⛔ 需决策
...
### AF-43 admin.keys.view 承载端点（RB-02 落地）✅（2026-09-08 b840631 落地） P2
...
### AF-51 session_timeout_minutes 无消费方 ✅（2026-09-08 b840631 落地） P2 ⛔ 需决策
...
### AF-52 log_level 修改后不热生效 ✅（2026-09-08 b840631 落地） P2
...
### AF-53 权限键单一事实源 + 启动自检 ✅（2026-09-08 b840631 落地） P2
...
### AF-54 MSW 模式可见化 ✅（2026-09-08 b840631 落地） P3
...
### AF-55 桌面端 PIN 明文存储 ✅（2026-09-08 b840631 落地） P2
