...
> ### ⚠️ 2026-09-16 重要修正（先读这段）
>
> **1. 主体要求：个体工商户即可，不需要公司、不需要对公账户。**
> 结算账户可直接用**经营者本人银行卡**。「对公账户」是有限责任公司的要求，
> 本文件早期版本按企业口径写，已在下方逐处修正。
>
> **2. 前置条件现状**
> | 条件 | 状态 |
> |---|---|
> | 已备案域名（回调必须） | ✅ 已完成（`api.clipchain.top`，苏ICP备2026067775号-1） |
> | 营业执照 | ✅ 个体工商户已注册 |
> | 对公账户 | ✅ **不需要** |
> | 微信/支付宝商户号 | ❌ 待申请 |
>
> **3. 代码现状远比本文档原描述的差。**
> 原文说「已完成核心订阅逻辑和Mock支付」容易让人以为只差填凭据。
> **实测（2026-09-16）：微信/支付宝的回调路由不可达、被登录鉴权拦住、
> 签名格式用错、未解密 resource、下单未实现。**
> 详见 `docs/audit/external-dependency-audit-2026-09-09.md` 的 B1「回调阻断项」。
> **这些是代码改动，必须在拿到商户号之前完成。**

支付渠道集成是商业化上线的**硬性前置条件**。真实支付渠道需要以下外部依赖：

1. **微信支付商户号**（国内主渠道）
2. **支付宝商户号**（国内备选）
3. **Stripe账号**（国际渠道）— ⚠️ 不对中国大陆主体开放，个体户现阶段不用考虑
...
2. **申请微信支付商户号**
   ...
   - 提交资质（营业执照、经营者/法人身份证、**结算银行卡**）
   - > ⚠️ **2026-09-16 修正**：原文写「对公账户」——**个体工商户不需要对公账户**，
     > 结算账户可直接用**经营者本人银行卡**。「对公账户」是有限责任公司的要求。
   - 等待审核（1-3工作日）
...
1. **注册支付宝开放平台账号**
   ...
   - 使用**已实名认证**的支付宝账号登录
   - > ⚠️ **2026-09-16 修正**：原文写「使用**企业**支付宝账号登录」，
     > **个体工商户可申请**，无需公司，也无需对公账户。
...
4. **签约商户号**
   - 前往"商家中心"完成入驻
   - 提交资质（营业执照 + 经营者身份证 + 结算银行卡）
   - > ⚠️ **2026-09-16 修正**：原文写「提交**企业**资质」——个体工商户可用
   - 等待审核（1-3工作日）
...
| 企业资质（结算账户信息） | Stripe要求的企业/个体信息 | 在Stripe Dashboard提交 |

> ⚠️ **2026-09-16 补充**：Stripe **不向中国大陆主体开放**收单，
> 本节的「注册时地区选 China」在实践中走不通。个体户现阶段**不用考虑 Stripe**，
> 国内微信/支付宝已足够；若将来要做海外收款，需先有境外主体。
> 下方第 2 步列的「对公账户」按 Stripe 海外口径保留，不代表国内渠道的要求。
...
2. **激活账号**
   ...
   - 提交资质（营业执照、法人/经营者身份证、结算账户信息）
   - 等待审核（3-7工作日）
   - > ⚠️ 见本节开头：Stripe 不对中国大陆主体开放，此步实际走不通
